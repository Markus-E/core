...
class Util {
	...
	public function setupServerSide($passphrase = null) {
		...
		if (false === $this->recoveryEnabledForUser()) {
			\OC_Preferences::setValue($this->userId, 'files_encryption', 'recovery_enabled', 0);
			\OC_Preferences::setValue($this->userId, 'files_encryption', 'migration_status', self::MIGRATION_OPEN);
		}
	...
	public function recoveryEnabledForUser() {
		...
		$recoveryMode = \OC_Preferences::getValue($this->userId, 'files_encryption', 'recovery_enabled');

		return ($recoveryMode === null) ? false : (int)$recoveryMode;
	...
	private function setMigrationStatus($status, $preCondition = null) {
		...
		$result = \OC_Preferences::setValue($this->userId, 'files_encryption', 'migration_status', $status, $preCondition);
		return $result;
